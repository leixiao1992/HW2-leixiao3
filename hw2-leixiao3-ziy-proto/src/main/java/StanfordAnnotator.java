...
import additional.Stanford;
import cmu.edu.leixiao.Sentence;
import cmu.edu.leixiao.gene;

/**
 * This is a casAnnotator of the system which use Stanford Method to recognize
 ...
 * method, it will automatically return a Hashmap.Through traversing the hash
 * map, we could get the begin and end of each gene tag of the sentence.
 *
 * @author Lei Xiao
 */
...
public class StanfordAnnotator extends JCasAnnotator_ImplBase {
	...
	public void process(JCas aJCas) throws AnalysisEngineProcessException {
		...
		while (iter.isValid()) {
			...
			/**
			 * return the result of the map the key of map is the beginning of
			 * the genetag the value of map is the end of the genetag
			 */
